/* EX.NO: 5 - Recognize valid control structure syntax of C language */
%{
#include <stdio.h>
#include <stdlib.h>
%}
...
RESULT: Thus the program to recognize a valid control structure syntax of C language
(For loop, while loop, if-else, if-else-if, switch-case, etc.) using LEX and YACC was executed
